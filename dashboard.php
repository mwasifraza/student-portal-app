        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 box">
                ...
                <div>
                    ...
                    <h4>Teacher: </h4>
                    <h4>Day: </h4>
                    <button class="btn btn-outline btn-primary btn-sm btn-block mt-4" data-toggle="modal" data-target="#Modal-Enroll">
                        Change Course 
                    </button>
                    <button class="btn btn-outline btn-primary btn-sm btn-block"  data-toggle="modal" data-target="#Modal-Unenroll">
                        Unenroll
                    </button>
                </div>
                <div>
